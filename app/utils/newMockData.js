...
const NEW_MOCK_RESPONSES = {
  ...
  [DOCUMENT_TYPES.PAN_COMPREHENSIVE]: {
    success: {
      data: {
        data: {
  ...
  [DOCUMENT_TYPES.BANK_VERIFICACTION]: {
    success: {
      data: {
        data: {
  ...
  [DOCUMENT_TYPES.CORPORATE_GSTIN]: {
    success: {
      data: {
        data: {
          address_details: {},
  ...
  [DOCUMENT_TYPES.CREDIT_REPORT_PDF]: {
    success: {
      data: {
        data: {
...
module.exports = NEW_MOCK_RESPONSES
