...
class VerifyMobileWithRCController {
  ...
  static async verifyMobileTest(req, res) {
    try {
      const { documentData } = req.body

      // Return success or failure mock response based on whether documentData is provided
      const mockResponse = documentData
        ? MOCK_RESPONSES.rc_number_mobile.success.data
        : MOCK_RESPONSES.rc_number_mobile.failure.data
...
module.exports = VerifyMobileWithRCController
