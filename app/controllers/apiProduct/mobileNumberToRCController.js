...
class VerifyRCWithMobileController {
  static async verifyRC(req, res) {
    let documentType
    try {
  ...
  static async verifyRCTest(req, res) {
    try {
      const { documentData } = req.body

      // Return success or failure mock response based on whether documentData is provided
      const mockResponse = documentData
        ? MOCK_RESPONSES.mobile_number_rc.success.data
        : MOCK_RESPONSES.mobile_number_rc.failure.data
...
module.exports = VerifyRCWithMobileController
