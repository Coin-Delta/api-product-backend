...
class VerifyPanWithAadhaarController {
  static async VerifyPanWithAadhaar(req, res) {
    try {
  ...
  static async VerifyPanWithAadhaarTest(req, res) {
    try {
      const { documentData } = req.body

      // Return success or failure mock response based on whether documentData is provided
      const mockResponse = documentData
        ? MOCK_RESPONSES.aadhaar_pan_link.success.data
        : MOCK_RESPONSES.aadhaar_pan_link.failure.data
...
module.exports = VerifyPanWithAadhaarController
