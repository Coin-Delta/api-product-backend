...
class EchallanController {
  static async verifyEchallan(req, res) {
    try {
      ...
      try {
        ...
        return result.success
          ? ResponseHelper.success(
              res,
              result.data,
              'Driving License verification successful'
            )
...
module.exports = EchallanController
