...
class PANToUANController {
  static async verifyUANWithPAN(req, res) {
    let documentType
    try {
  ...
  static async verifyUANWithPANTest(req, res) {
    try {
      const { documentData } = req.body

      // Return success or failure mock response based on whether documentData is provided
      const mockResponse = documentData
        ? MOCK_RESPONSES.pan_to_uan.success.data
        : MOCK_RESPONSES.pan_to_uan.failure.data
      ...
      return mockResponse.success
        ...
        : ResponseHelper.error(
            ...
            mockResponse.status_code,
            {
              ...
              messageCode: mockResponse.messageCode,
              remark: mockResponse.remark
            },
            mockResponse.remark,
            null,
            mockResponse.messageCode
...
module.exports = PANToUANController
