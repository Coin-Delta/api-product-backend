...
class EcourtByCNRController {
  static async verifyEcourtCNR(req, res) {
    try {
      ...
      try {
        ...
        return result.success
          ? ResponseHelper.success(
              res,
              result.data,
              'Ecourt CNR verification successful'
            )
          : ResponseHelper.error(
              res,
              'Ecourt CNR verification failed',
              400,
              result.error
            )
      } catch (error) {
...
module.exports = EcourtByCNRController
