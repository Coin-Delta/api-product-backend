...
class FSSAIVerification {
  static async verifyFSSAI(req, res) {
    let documentType
    try {
  ...
  static async verifyFSSAITest(req, res) {
    try {
      const { documentData } = req.body

      // Return success or failure mock response based on whether documentData is provided
      const mockResponse = documentData
        ? MOCK_RESPONSES.fssai_verification.success.data
        : MOCK_RESPONSES.fssai_verification.failure.data
...
module.exports = FSSAIVerification
