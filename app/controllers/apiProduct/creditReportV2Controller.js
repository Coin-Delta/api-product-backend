...
class CreditReportV2Controller {
  ...
  static async verifyCreditReportPdfTest(req, res) {
    try {
      ...
      const mockResponse = documentData
        ? MOCK_RESPONSES.credit_report_v2.success.data
        : MOCK_RESPONSES.credit_report_v2.failure.data
...
module.exports = CreditReportV2Controller
