...
class EmploymentHistoryAdvanceController {
  ...
  static async verifyEmploymentHistoryTest(req, res) {
    try {
      ...
      const mockResponse = documentData
        ? MOCK_RESPONSES.employment_history_uan_advance.success.data
        : MOCK_RESPONSES.employment_history_uan_advance.failure.data
...
module.exports = EmploymentHistoryAdvanceController
